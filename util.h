...
std::wstring formatNumber(const long long number, const size_t sigFigs = SIZE_MAX, const size_t leadingZeroes = 0, const size_t minExp = SIZE_MAX);
std::wstring formatNumber(long double number, const size_t sigFigs = SIZE_MAX, const size_t leadingZeroes = 0, const size_t minExp = SIZE_MAX);
